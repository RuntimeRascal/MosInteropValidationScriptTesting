...
#Region "Contructor"
        ...
        Public Sub New()
            _localParameters = New Object() {True, ' Compiler result (Pre-Code or Post-Code) True or False
                                          ...
                                          New List(Of String) From {"Red1", "Red2", "Red3"}, ' RedWords
                                          New List(Of String), ' GreenWords
                                          New List(Of String), ' PurpleWords
                                          New List(Of String) ' YellowWords
                                         }

            RefreshParameterCollection()

            ValidateQuestionCommand = New RelayCommand(Sub() ValidateQuestion(_localParameters))
        ...
        Private Sub RefreshParameterCollection()
            PreCodeRadio = CType(_localParameters(0), Boolean)
            Templates = New ObservableCollection(Of String)(CType(_localParameters(1), List(Of String)))
            OrangeWords = New ObservableCollection(Of String)(CType(_localParameters(2), List(Of String)))
            BlueWords = New ObservableCollection(Of String)(CType(_localParameters(2), List(Of String)))
            RedWords = New ObservableCollection(Of String)(CType(_localParameters(2), List(Of String)))
            GreenWords = New ObservableCollection(Of String)(CType(_localParameters(2), List(Of String)))
            PurpleWords = New ObservableCollection(Of String)(CType(_localParameters(2), List(Of String)))
            YellowWords = New ObservableCollection(Of String)(CType(_localParameters(2), List(Of String)))
        End Sub
#End Region
...
#Region "Properties"
        Dim _templates As ObservableCollection(Of String)
        Property Templates() As ObservableCollection(Of String)
            Get
                Return _templates
            End Get
            Set(value As ObservableCollection(Of String))
                [Set](Function() Templates, _templates, value)
            End Set
        End Property

        Dim _orangeWords As ObservableCollection(Of String)
        Property OrangeWords() As ObservableCollection(Of String)
            Get
                Return _orangeWords
            End Get
            Set(value As ObservableCollection(Of String))
                [Set](Function() OrangeWords, _orangeWords, value)
            End Set
        End Property

        Dim _blueWords As ObservableCollection(Of String)
        Property BlueWords() As ObservableCollection(Of String)
            Get
                Return _blueWords
            End Get
            Set(value As ObservableCollection(Of String))
                [Set](Function() BlueWords, _blueWords, value)
            End Set
        End Property

        Dim _redWords As ObservableCollection(Of String)
        Property RedWords() As ObservableCollection(Of String)
            Get
                Return _redWords
            End Get
            Set(value As ObservableCollection(Of String))
                [Set](Function() RedWords, _redWords, value)
            End Set
        End Property

        Dim _greenWords As ObservableCollection(Of String)
        Property GreenWords() As ObservableCollection(Of String)
            Get
                Return _greenWords
            End Get
            Set(value As ObservableCollection(Of String))
                [Set](Function() GreenWords, _greenWords, value)
            End Set
        End Property

        Dim _purpleWords As ObservableCollection(Of String)
        Property PurpleWords() As ObservableCollection(Of String)
            Get
                Return _purpleWords
            End Get
            Set(value As ObservableCollection(Of String))
                [Set](Function() PurpleWords, _purpleWords, value)
            End Set
        End Property

        Dim _yellowWords As ObservableCollection(Of String)
        Property YellowWords() As ObservableCollection(Of String)
            Get
                Return _yellowWords
            End Get
            Set(value As ObservableCollection(Of String))
                [Set](Function() YellowWords, _yellowWords, value)
            End Set
        End Property

        Dim _preCode As Boolean
        Property PreCodeRadio() As Boolean
            Get
                Return _preCode
            End Get
            Set(value As Boolean)
                [Set](Function() PreCodeRadio, _preCode, value)
                If value Then
                    _localParameters(0) = value
                End If
            End Set
        End Property

        Dim _postCode As Boolean
        Property PostCodeRadio() As Boolean
            Get
                Return _postCode
            End Get
            Set(value As Boolean)
                [Set](Function() PostCodeRadio, _postCode, value)
                If Not value Then
                    _localParameters(0) = value
                End If
        ...
        Public Overridable Property MyOfficeApp() As Microsoft.Office.Interop.Word.Application
            ...
            Set
                _myOfficeApp = Value
                RaisePropertyChanged("MyOfficeApp")
            End Set
        End Property
        ...
        Public Overridable Property LocalParameters() As Object()
            Get
                Return _localParameters
            End Get
            Set
                [Set](Function() LocalParameters, _localParameters, Value)
            End Set
        End Property
#End Region
