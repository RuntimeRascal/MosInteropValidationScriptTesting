...
Public Class DynamicQuestion
    ...
    Public Overridable Function Validate8817(ByVal ParamArray Parameters As Object()) As [Object]
        ...
        Try
            ...
            If programingWords.Count = 0 Then
                ...
                programingWords.Add("*SELECT*CUSTOMERS*CUSTOMERID*ORDERS*ORDERSTATUS*FROM*CUSTOMERS*INNER JOIN*ORDERS*") _
                '12
                ...
                For aT = 0 To Me.MyOfficeApp.CurrentData.AllTables.Count - 1
                    If Me.MyOfficeApp.CurrentData.AllTables(aT).Name = programingWords(0) Then
                        If Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields.Count = 8 Then
                            If _
                                Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields(0).Name =
                                programingWords(1) Then
                ...
                For aT1 = 0 To Me.MyOfficeApp.CurrentData.AllTables.Count - 1
                    If Me.MyOfficeApp.CurrentData.AllTables(aT1).Name = programingWords(0) Then
                        If Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Indexes.Count = 1 Then
                            If _
                                Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Indexes(0).Name =
                                programingWords(2) Then
                        ...
                        ElseIf Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Indexes.Count = 2 Then
                            If _
                                Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Indexes(1).Name =
                                programingWords(2) Then
            ...
            Try
                ...
                For aT2 = 0 To Me.MyOfficeApp.CurrentData.AllTables.Count - 1
                    If Me.MyOfficeApp.CurrentData.AllTables(aT2).Name = programingWords(0) Then
                        ...
                        If _
                            Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields(7).Type = 8 Or
                            Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields(7).Type = 10 Then
                            If _
                                Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields(7).DefaultValue =
                                programingWords(3) Or
                                Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields(6).DefaultValue =
                                programingWords(3) Then
                                If _
                                    Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields(7).Required Or
                                    Me.MyOfficeApp.CurrentDb.TableDefs(programingWords(0)).Fields(6).Required Then
                                    points(3) = True
                                    Exit For
                                End If
                            End If
            ...
            Try
                If CInt(Me.MyOfficeApp.CurrentDb.Relations.Count) > 1 Then
                    If Me.MyOfficeApp.CurrentDb.Relations(0).Attributes = 0 Then
                        If Me.MyOfficeApp.CurrentDb.Relations(0).Fields(0).ForeignName.ToString = programingWords(1) _
                            Then
                ...
                If CInt(Me.MyOfficeApp.CurrentDb.Relations.Count) > 1 Then
                    If Me.MyOfficeApp.CurrentDb.Relations(3).Attributes = 0 Then
                        If Me.MyOfficeApp.CurrentDb.Relations(3).Fields(0).ForeignName.ToString = programingWords(1) _
                            Then
            ...
            Try
                If CInt(Me.MyOfficeApp.CurrentDb.Relations.Count) > 3 Then
                    If Me.MyOfficeApp.CurrentDb.Relations(3).Attributes = 2 Then
                        If Me.MyOfficeApp.CurrentDb.Relations(3).Fields(0).ForeignName.ToString = programingWords(5) _
                            Then
                            If _
                                Me.MyOfficeApp.CurrentDb.Relations(3).Fields(0).Name.ToString.ToUpper() =
                                programingWords(5).ToUpper() Then
                                points(1) = True
                            End If
                        End If
                    End If
                ...
                If CInt(Me.MyOfficeApp.CurrentDb.Relations.Count) > 3 Then
                    If Me.MyOfficeApp.CurrentDb.Relations(2).Attributes = 2 Then
                        If Me.MyOfficeApp.CurrentDb.Relations(2).Fields(0).ForeignName.ToString = programingWords(5) _
                            Then
                            If _
                                Me.MyOfficeApp.CurrentDb.Relations(2).Fields(0).Name.ToString.ToUpper() =
                                programingWords(5).ToUpper() Then
                                points(1) = True
                            End If
                        End If
            ...
            Try
                If CInt(Me.MyOfficeApp.CurrentDb.Relations.Count) > 4 Then
                    If Me.MyOfficeApp.CurrentDb.Relations(4).Attributes = 2 Then
                        If Me.MyOfficeApp.CurrentDb.Relations(4).Fields(0).ForeignName.ToString = programingWords(6) _
                            Then
    ...
    Public Overridable Function Validate8824(ByVal ParamArray Parameters As Object()) As [Object]
        ...
        Else ' Start Validation-Code
            ...
            Try
                Me.MyOfficeApp.DoCmd.Close(3, programingWords(19)) _
                ' 3 is a report object type https://msdn.microsoft.com/en-us/library/office/ff845495.aspx
                ...
                Try
                    ...
                    Try
                        If Me.MyOfficeApp.Reports(aR).Controls(3).Name.ToString = programingWords(21) Then
                            If Me.MyOfficeApp.Reports(aR).Controls(10).Name.ToString = programingWords(22) Then
                                If _
                                    Me.MyOfficeApp.Reports(aR).Controls(2).Width >= 1133 And
                                    Me.MyOfficeApp.Reports(aR).Controls(2).Width <= 1152 Then
                                    If _
                                        Me.MyOfficeApp.Reports(aR).Controls(1).Caption.ToString = programingWords(20) Or
                                        Me.MyOfficeApp.Reports(aR).Controls(1).Name.ToString = programingWords(20) Then
                                        points(1) = True
                                    End If
                                End If
                            End If
                    ...
                    Try
                        If Me.MyOfficeApp.Reports(aR).Section(1).Name = programingWords(23) Then
                            If _
                                Me.MyOfficeApp.Reports(aR).Section(1).Height >= 1418 And
                                Me.MyOfficeApp.Reports(aR).Section(1).Height <= 1440 Then
    ...
    Public Overridable Sub CloseApp()
        Try
            If MyOfficeApp IsNot Nothing Then
                ...
                End If
                MyOfficeApp.Quit([Option] := AcQuitOption.acQuitSaveNone)
                If MyOfficeApp IsNot Nothing Then
